...
export default function LatestPostsCard({ post }) {
  return (
    <Card className="bg-white w-full sm:w-1/2 shadow-md rounded-md px-3 flex flex-col sm:flex-row items-start md:items-center justify-between mx-6 sm:mx-2 my-4">
